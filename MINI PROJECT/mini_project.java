...
{ 
  ...
  {   
    ...
    System.out.print("Enter the type of conversion you want to do : l->length , a->area , v->volume , s->speed , w-> weight , t-> temperature , p-> power , k-> pressure , c->currency , e-> energy , m-> angle \n");
